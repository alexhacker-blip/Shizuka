...
from Shizuka import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL, TOKEN, DONATION_LINK, BLACKLIST_CHATS, WHITELIST_CHATS, MESSAGE_DUMP
from Shizuka.modules import ALL_MODULES
from Shizuka.modules.purge import client
...
import Shizuka.modules.helper_funcs.panel_string as HELP_PANEL_STRING
from Shizuka.modules.connection import connected
from Shizuka.modules.connection import connect_button
...
SHIZUKA_GIF = HELP_PANEL_STRING.shizuka_GIF

SHIZUKA_IMG = HELP_PANEL_STRING.shizuka_IMG
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            if args[0].lower() == "help":
                ...
                update.effective_message.reply_photo(SHIZUKA_IMG, ABOUT_STRINGS, reply_markup=InlineKeyboardMarkup(BUTTONS_ABOUT), parse_mode=ParseMode.MARKDOWN, timeout=60, disable_web_page_preview=True)
            ...
            update.effective_message.reply_video(HELP_PANEL_STRING.shizuka_GIF, reply_markup=InlineKeyboardMarkup(BUTTONS_START), parse_mode=ParseMode.MARKDOWN)
    else:
        update.effective_message.reply_text("Yo, heyaa? 😜")
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                ...
                                                InlineKeyboardButton(text="👥 Support chat.",url="https://telegram.dog/ShizukaChat")]]))
        return
...
def donate(update, context):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1433053466 and DONATION_LINK:
